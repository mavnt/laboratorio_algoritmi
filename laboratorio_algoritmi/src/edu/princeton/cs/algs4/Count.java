...
public class Count {
	...
	/**
	 * Reads in text from standard input; calculates the frequency of occurrence of
	 * each character over the alphabet specified as a commmand-line argument; and
	 * prints the frequencies to standard output.
	 *
	 * @param args
