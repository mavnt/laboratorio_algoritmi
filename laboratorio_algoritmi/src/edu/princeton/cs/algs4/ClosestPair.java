...
public class ClosestPair {
	 ...
	 *
	 * @return one of the two points in the closest pair of points; {@code null} if
	 ...
	 *
	 * @return the other point in the closest pair of points {@code null} if no such
	 *         point (because there are fewer than 2 points)
	 */
	...
	/**
	 * Unit tests the {@code ClosestPair} data type. Reads in an integer {@code n}
	 * and {@code n} points (specified by their <em>x</em>- and
