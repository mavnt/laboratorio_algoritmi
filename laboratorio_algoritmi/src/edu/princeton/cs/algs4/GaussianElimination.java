...
public class GaussianElimination {
	 ...
	 * <em>A</em> is an <em>m</em>-by-<em>n</em> matrix and <em>b</em> is a length
	 * <em>m</em> vector.
	 *
	 * @param A
	 ...
	 *             if the dimensions disagree, i.e., the length of {@code b} does
	 *             not equal {@code m}
	 */
	...
	private static void test3() {
		double[][] A = { { 2, -3, -1, 2, 3 }, { 4, -4, -1, 4, 11 }, { 2, -5, -2, 2, -1 }, { 0, 2, 1, 0, 4 },
				{ -4, 6, 0, 0, 7 }, };
		double[] b = { 4, 4, 9, -6, 5 };
