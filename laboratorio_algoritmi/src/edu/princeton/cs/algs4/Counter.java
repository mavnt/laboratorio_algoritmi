...
public class Counter implements Comparable<Counter> {
	 ...
	 *         counter; a negative integer if the value of this counter is less than
	 *         the value of that counter; and a positive integer if the value of
	 *         this counter is greater than the value of that counter
	 */
	@Override
	...
	/**
	 * Reads two command-line integers n and trials; creates n counters; increments
	 * trials counters at random; and prints results.
	 *
	 * @param args
