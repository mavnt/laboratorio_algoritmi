...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	 ...
	 *            windows) or {@code JFrame.DISPOSE_ON_CLOSE} (close current window)
	 */
	...
	/**
	 * Draws a filled rectangle of given half width and half height, centered on (x,
	 * y).
	 *
	 * @param x
	 *            the x-coordinate of the center of the rectangle
	...
	/**
	 * Draws picture (gif, jpg, or png) centered on (x, y), rotated given number of
	 * degrees.
	 *
	 * @param x
	 *            the center x-coordinate of the image
