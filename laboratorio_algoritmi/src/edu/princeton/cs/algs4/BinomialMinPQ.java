...
public class BinomialMinPQ<Key> implements Iterable<Key> {
	...
	/**
	 * Initializes an empty priority queue using the given Comparator Worst case is
	 * O(1)
	 * 
	 * @param C
	...
	/**
	 * Initializes a priority queue with given keys using the given Comparator Worst
	 * case is O(n*log(n))
	 * 
	 * @param C
	 *            a comparator over the keys
	...
	/**
	 * Merges two Binomial heaps together This operation is destructive Worst case
	 * is O(log(n))
	 * 
	 * @param heap
	...
	/**
	 * Gets an Iterator over the keys in the priority queue in ascending order The
	 * Iterator does not implement the remove() method iterator() : Worst case is
	 * O(n) next() : Worst case is O(log(n)) hasNext() : Worst case is O(1)
	 * 
