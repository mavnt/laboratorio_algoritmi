...
public final class RectHV {
	...
	/**
	 * Initializes a new rectangle [<em>xmin</em>, <em>xmax</em>] x [<em>ymin</em>,
	 * <em>ymax</em>].
	 *
	 * @param xmin
	 ...
	 * @param that
	 *            the other rectangle
	 * @return {@code true} if this rectangle intersect the argument rectangle at
	 *         one or more points
	 */
	 ...
	 * @param p
	 *            the point
	 * @return {@code true} if this rectangle contain the point {@code p}, possibly
	 *         at the boundary; {@code false} otherwise
	 */
	 ...
	 *         point on this rectangle; 0 if the point is contained in this
	 *         rectangle
	 */
	 ...
	 *         the closest point on this rectangle; 0 if the point is contained in
	 *         this rectangle
	 */
	 ...
	 * @param other
	 *            the other rectangle
	 * @return {@code true} if this rectangle equals {@code other}; {@code false}
	 *         otherwise
	 */
	@Override
