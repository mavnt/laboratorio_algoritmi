...
public class KWIK {
	...
	/**
	 * Reads a string from a file specified as the first command-line argument; read
	 * an integer k specified as the second command line argument; then repeatedly
	 * processes use queries, printing all occurrences of the given query string in
	 * the text string with k characters of surrounding context on either side.
	 *
	 * @param args
