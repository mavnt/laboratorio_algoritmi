...
public class AVLTreeST<Key extends Comparable<Key>, Value> {
	...
	/**
	 * Returns value associated with the given key in the subtree or {@code null} if
	 * no such key.
	 * 
	 * @param x
	 *            the subtree
	 * @param key
	 *            the key
	 * @return value associated with the given key in the subtree or {@code null} if
	 *         no such key
	 */
	...
	/**
	 * Removes the specified key and its associated value from the symbol table (if
	...
	/**
	 * Returns the node in the subtree with the largest key less than or equal to
	 * the given key.
	 * 
	 * @param x
	 *            the subtree
	 * @param key
	 *            the key
	 * @return the node in the subtree with the largest key less than or equal to
	 *         the given key
	 */
	...
	/**
	 * Returns the node in the subtree with the smallest key greater than or equal
	 * to the given key.
	 * 
	 * @param x
	 *            the subtree
	 * @param key
	 *            the key
	 * @return the node in the subtree with the smallest key greater than or equal
	 *         to the given key
	 */
	 ...
	 * and max (if min or max is null, treat as empty constraint) Credit: Bob
