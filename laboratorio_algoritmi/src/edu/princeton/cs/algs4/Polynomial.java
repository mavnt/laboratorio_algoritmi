...
public class Polynomial {
	...
	/**
	 * Returns the product of this polynomial and the specified polynomial. Takes
	 * time proportional to the product of the degrees. (Faster algorithms are
	 * known, e.g., via FFT.)
	 *
	 * @param that
	 *            the other polynomial
	 ...
	 * Takes time proportional to the product of the degrees. (Faster algorithms are
	 * known, e.g., via FFT.)
	 *
	 * @param that
	 *            the other polynomial
	 ...
	 * @return {@code true} if this polynomial equals {@code other}; {@code false}
	 *         otherwise
	 */
	@Override
	...
	/**
	 * Compares two polynomials by degree, breaking ties by coefficient of leading
	 * term.
	 *
	 * @param that
	 *            the other point
	 ...
	 *         negative integer if this polynomialt is less than the argument
	 *         polynomial; and a positive integer if this polynomial is greater than
	 *         the argument point
	 */
