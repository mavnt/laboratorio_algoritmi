...
public class PictureDump {
	...
	/**
	 * Reads in a sequence of bytes from standard input and draws them to standard
	 * drawing output as a width-by-height picture, using black for 1 and white for
	 * 0 (and red for any leftover pixels).
	 *
	 * @param args
