...
public class RandomSeq {
	...
	/**
	 * Reads in two command-line arguments lo and hi and prints n uniformly random
	 * real numbers in [lo, hi) to standard output.
	 *
	 * @param args
	...
	public static void main(String[] args) {
		...
		// for backward compatibility with Intro to Programming in Java version of
		// RandomSeq
		if (args.length == 1) {
