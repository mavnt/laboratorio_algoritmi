...
public class FloydWarshall {
	 ...
	 * the edge-weighted digraph {@code G}. If no such shortest path exists for some
	 * pair of vertices, it computes a negative cycle.
	 * 
	 * @param G
	 ...
	 * 
	 * @return a negative cycle as an iterable of edges, or {@code null} if there is
	 *         no such cycle
	 */
