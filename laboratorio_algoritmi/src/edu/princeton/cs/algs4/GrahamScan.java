...
public class GrahamScan {
	...
	/**
	 * Unit tests the {@code GrahamScan} data type. Reads in an integer {@code n}
	 * and {@code n} points (specified by their <em>x</em>- and
	 * <em>y</em>-coordinates) from standard input; computes their convex hull; and
	 * prints out the points on the convex hull to standard output.
	 *
	 * @param args
