...
public class GraphGenerator {
	 ...
	 * @param E
	 *            the number of vertices
	 * @return a random simple graph on {@code V} vertices, containing a total of
	 *         {@code E} edges
	...
	/**
	 * Returns a random simple graph on {@code V} vertices, with an edge between any
	 * two vertices with probability {@code p}. This is sometimes referred to as the
	 ...
	 * @return a random simple graph on {@code V} vertices, with an edge between any
	 *         two vertices with probability {@code p}
	 * @throws IllegalArgumentException
	 ...
	 *            the number of vertices in the other partition
	 * @param p
	 *            the probability that the graph contains an edge with one endpoint
	 *            in either side
	 * @return a random simple bipartite graph on {@code V1} and {@code V2}
	 *         vertices, containing each possible edge with probability {@code p}
	 * @throws IllegalArgumentException
	 ...
	 * @return a graph that is an Eulerian cycle on {@code V} vertices and {@code E}
	 *         edges
	 * @throws IllegalArgumentException
	 ...
	 * @return a graph that is an Eulerian path on {@code V} vertices and {@code E}
	 *         edges
	 * @throws IllegalArgumentException
	 *             if either {@code V <= 0} or {@code E < 0}
	 */
	...
	/**
	 * Returns a uniformly random {@code k}-regular graph on {@code V} vertices (not
	 * necessarily simple). The graph is simple with probability only about
	...
	/**
	 * Returns a uniformly random tree on {@code V} vertices. This algorithm uses a
	 * Prufer sequence and takes time proportional to <em>V log V</em>.
	 * 
	 * @param V
