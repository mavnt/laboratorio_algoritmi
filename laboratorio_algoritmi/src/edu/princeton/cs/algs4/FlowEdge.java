...
public class FlowEdge {
	...
	/**
	 * Initializes an edge from vertex {@code v} to vertex {@code w} with the given
	 * {@code capacity} and zero flow.
	 * 
	 * @param v
	 *            the tail vertex
	 * @param w
	 ...
	 *         vertex If {@code vertex} is the tail vertex, the residual capacity
	 *         equals {@code capacity() - flow()}; if {@code vertex} is the head
	 *         vertex, the residual capacity equals {@code flow()}.
	 * @throws IllegalArgumentException
	 *             if {@code vertex} is not one of the endpoints of the edge
	 */
	 ...
	 * {@code delta}; if {@code vertex} is the head vertex, this decreases the flow
	 * on the edge by {@code delta}.
	 * 
	 * @param vertex
	 *            one endpoint of the edge
	 * @param delta
	 ...
	 *             if {@code vertex} is not one of the endpoints of the edge
	 * @throws IllegalArgumentException
	 *             if {@code delta} makes the flow on on the edge either negative or
